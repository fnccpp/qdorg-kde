///file per l'interfaccia del widget in rappresentazione estesa
...
FocusScope {
	...
	Layout.preferredHeight: Math.min(Math.max(units.gridUnit * 27, maxContentHeight), Screen.desktopAvailableHeight) // Binding loop warning (meh).
